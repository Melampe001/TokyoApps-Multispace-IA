    ...
    def _load_config(self, config_path: str) -> dict:
        ...
        if config_path and os.path.exists(config_path):
            with open(config_path, "r") as f:
                return json.load(f)
        return {
            "naming_conventions": {"files": "snake_case", "classes": "PascalCase"},
            "ui_checks": {"check_hardcoded_strings": True, "check_theme_usage": True},
        }
...
def main():
    ...
    parser.add_argument(
        "--check-hardcoded-strings", action="store_true", help="Check for hardcoded strings"
    )
